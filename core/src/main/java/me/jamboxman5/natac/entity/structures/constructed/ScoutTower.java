...
public class ScoutTower extends Structure {
    ...
    public static final String spritePath = "structure/constructed/scout_tower.png";
    ...
    public ScoutTower(Player owner, Vector2 tilePos, Vector2 pos) {
        super(goldCost, resourceCost, 0, 0, 20, tilePos, pos, name, owner.getID());
    }
